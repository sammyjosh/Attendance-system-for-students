            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        face = Label(first, text="Management of Employee", bg="green", fg="yellow", padx=15, pady=15,
                        ...
                        titles = Label(f2, text="Manage Employee", bg="gray", font=("Italic", 20, "bold")).place(x=90,
                                                                                                                 y=30)
                        ...
                        btn1 = Button(f3, text="Add", bg="green", height="1", width="7", command=add_employee,
                        ...
                        table1 = Treeview(f5,
                                          columns=("eid", "post", "fname", "gender", "contact.no", "address", "DOJ"),
                ...
                def face_embedding():
                    ...
                    if not os.path.exists(embeddings_model_file):
                        ...
                        if data != None:
                            ...
                            backbtn = Button(fe, text='Back', fg='White', bg='green',
                ...
                B1 = Button(attendance, image=photo1, text="Employee Management", font=("Times New Roman", 15),
                            fg="green", height=230, width=265, command=manage_employee, compound=BOTTOM)
                B1.place(x=20, y=100)
